...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Normal", "666666", "eeeeee", "")
    ...
    call <SID>X("Folded", "406270", "cccccc", "")
    call <SID>X("FoldColumn", "d2b48c", "4d4d4d", "")
    call <SID>X("IncSearch", "708090", "f0e68c", "")
    "LineNr
    call <SID>X("LineNr", "666688", "", "")
    call <SID>X("ModeMsg", "daa520", "", "")
    call <SID>X("MoreMsg", "2e8b57", "", "")
    call <SID>X("NonText", "addbe7", "bbbbbb", "bold")
    ...
    call <SID>X("Comment", "406270", "", "")
    call <SID>X("Constant", "6f4646", "", "")
    call <SID>X("Identifier", "3b623b", "", "none")
    call <SID>X("Statement", "7b7f62", "", "bold")
    call <SID>X("PreProc", "4e2323", "", "")
    call <SID>X("Type", "bdb76b", "", "bold")
    call <SID>X("Special", "87765c", "", "")
    "Underlined
